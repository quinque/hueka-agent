...
while True:
    ...
    response = requests.post("https://api.himmelueberkarlsruhe.de/", json={"timestamp":timestamp.isoformat(), "naivecolor":str(naivecolor), "light":ltr.light, "rgbhex":str(rgbhex), "latitude":latitude, "longitude":longitude, "description":description})
